...
{
  /* Exit RUN0 mode by configuring LDO power supply. */
...
{
  /* Add timeout to prevent hanging during power initialization */
  uint32_t timeout = 1000000UL;
    ...
    PWR->CR3 |= PWR_CR3_LDOEN;
  #endif /* SMPS */
  /* Wait till voltage level flag is set (with timeout) */
